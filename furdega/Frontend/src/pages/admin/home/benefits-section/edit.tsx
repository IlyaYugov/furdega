  ...
  return (
    <Row className="flex-column gy-3">
      ...
      <Col>
        ...
        <BenefitEdit value={example1} onChange={onExample1Change} />
      </Col>
      ...
      <Col>
        ...
        <BenefitEdit value={example2} onChange={onExample2Change} />
      </Col>
      ...
      <Col>
        ...
        <BenefitEdit value={example3} onChange={onExample3Change} />
      </Col>
