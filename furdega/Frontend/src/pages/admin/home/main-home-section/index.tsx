...
import { mainHomeSectionApi } from "../../../../api/main-home-section-api"
import { MainHomeSectionRequest } from "../../../../types/main-home-section"
...
const MainHomeSection: FC = () => {
  ...
  const fetchContent = async () => {
    const response = await mainHomeSectionApi.get()
    setHeader(response.header)
    setImageUrl(response.imageUrl)
  }

  const submit = async (request: MainHomeSectionRequest) => {
    await mainHomeSectionApi.createOrUpdate(request)
    reset()
  }
